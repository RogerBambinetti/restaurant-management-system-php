...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/loginClient.css" />
    ...
    <div class="container" id="container">
        ...
        <div class="login">
            ...
            <form>
                ...
                <button type="submit" id="loginClient">Submit</button>
                <div class="register">
                    <label>Don't have an account? <a href="insertClient.php">Sign up</a></label>
                </div>
            </form>
        </div>
    </div>
        ...
        $.ajax({
            ...
            success: function(resposta) {
                if (resposta) {
                    ...
                    $(location).attr("href", "../client/indexClient.php");
                }
            }
        });
        return false;
